...
return [
    'Andhra Pradesh' => [
        ...
        'Vizianagaram', 'West Godavari', 'Nellore', 'Palnadu', 'Nandyal',
        'Kakinada', 'Anakapalli', 'Alluri Sitharama Raju', 'Parvathipuram Manyam',
        'Sri Sathya Sai', 'Bapatla', 'Eluru', 'Kona Seema', 'Tirupati'
    ],
    'Arunachal Pradesh' => [
    ...
    'Chhattisgarh' => [
        ...
        'Surajpur', 'Surguja', 'Gaurela-Pendra-Marwahi', 'Manendragarh', 'Sakti',
        'Sarangarh-Bilaigarh', 'Mohla-Manpur', 'Khairagarh-Chhuikhadan-Gandai'
    ],
    ...
    'Madhya Pradesh' => [
        ...
        'Chachaura', 'Chhatarpur', 'Chhindwara', 'Damoh', 'Datia',
        'Dewas', 'Dhar', 'Dindori', 'Guna', 'Gwalior',
        'Harda', 'Hoshangabad', 'Indore', 'Jabalpur', 'Jhabua',
        'Katni', 'Khandwa', 'Khargone', 'Maihar', 'Mandla',
        'Mandsaur', 'Morena', 'Nagda', 'Narsinghpur', 'Neemuch',
        'Nivari', 'Panna', 'Raisen', 'Rajgarh', 'Ratlam',
    ...
    'Sikkim' => ['Gangtok', 'Gyalshing', 'Mangan', 'Namchi', 'Pakyong', 'Soreong'],
    'Tamil Nadu' => [
    ...
    'Ladakh' => ['Kargil', 'Leh'],
    'Lakshadweep' => ['Agatti', 'Amini', 'Andrott', 'Kavaratti', 'Kiltan', 'Minicoy'],
