...
<?php else: ?>
    <header class="hero-section text-center" style="background: linear-gradient(135deg, #003566 0%, #001a3a 100%); height: 500px;">
        <div class="container-fluid px-lg-5">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 ps-lg-5">
                <span class="badge px-3 py-2 rounded-pill mb-3 fw-semibold" style="background: rgba(13,148,136,0.12); color: #0d9488;">Who We Are</span>
                <h2 class="fw-bold display-6 mb-3" style="color: #003566;">About Us</h2>
                ...
                <div class="mt-4">
                    <a href="<?php echo url('/about'); ?>" class="btn rounded-pill px-4 py-2 fw-semibold" style="border: 2px solid #0d9488; color: #0d9488;">
...
<section class="py-5" style="background: #fffff0;">
    <div class="container">
        <div class="text-center mb-5">
            <span class="badge px-3 py-2 rounded-pill mb-3 fw-semibold" style="background: rgba(0,53,102,0.1); color: #003566;">Our Impact</span>
            <h2 class="fw-bold display-6" style="color: #003566;">Recent Projects</h2>
                        ...
                        <div style="height: 180px; overflow: hidden; position: relative;">
                            ...
                            <?php else: ?>
                                <div class="w-100 h-100 d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #00356610, #0d948810);">
                                    <i class="fas fa-project-diagram fa-3x" style="color: #003566; opacity: 0.2;"></i>
                                </div>
                            <?php endif; ?>
                            <div class="position-absolute top-0 start-0 m-2">
                                <span class="badge px-2 py-1 rounded-pill fw-semibold text-white" style="background: <?php echo $project->status === 'completed' ? '#2ecc71' : '#003566'; ?>; font-size: 0.65rem;"><?php echo ucfirst($project->status); ?></span>
                            </div>
                        </div>
        ...
        <div class="text-center mt-4">
            <a href="<?php echo url('/projects'); ?>" class="btn rounded-pill px-4 fw-semibold" style="border: 2px solid #003566; color: #003566;">
...
<!-- CTA Section -->
<section class="py-5" style="background: linear-gradient(135deg, #003566 0%, #00224d 100%);">
...
<section class="py-5" style="background: #fffff0;">
    <div class="container">
        <div class="text-center mb-5">
            <span class="badge px-3 py-2 rounded-pill mb-3 fw-semibold" style="background: rgba(13,148,136,0.12); color: #0d9488;">Support Us</span>
            <h2 class="fw-bold display-6" style="color: #003566;">Active Campaigns</h2>
                ...
                <a href="<?php echo url('campaigns/' . $campaign->slug); ?>" class="text-decoration-none">
                    <div class="card border-0 shadow-sm hover-lift rounded-4 overflow-hidden h-100">
                        <div style="height: 180px; overflow: hidden; position: relative;">
                            ...
                            <?php else: ?>
                                <div class="w-100 h-100 d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #0d948810, #00356605);">
                                    <i class="fas fa-hand-holding-heart fa-3x" style="color: #0d9488; opacity: 0.2;"></i>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center small mb-1">
                                <span class="fw-bold" style="color: #003566;">₹<?php echo number_format($campaign->raised_amount); ?></span>
                            ...
                            <div class="progress" style="height: 5px; border-radius: 1rem;">
                                <div class="progress-bar" style="width: <?php echo $cProgress; ?>%; background: linear-gradient(90deg, #003566, #0d9488); border-radius: 1rem;"></div>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="text-center mt-4">
            <a href="<?php echo url('/campaigns'); ?>" class="btn rounded-pill px-4 fw-semibold" style="border: 2px solid #0d9488; color: #0d9488;">
...
<section class="py-5" style="background: #fffff0;">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold display-6" style="color: #003566;">Gallery & Recognitions</h2>
        ...
        <div class="row g-4">
            <div class="col-12 col-md-4">
                <a href="<?php echo url('/gallery'); ?>" class="text-decoration-none">
                    <div class="card border-0 shadow-sm hover-lift rounded-4 overflow-hidden text-center p-4 h-100" style="background: linear-gradient(135deg, #7c3aed08, #7c3aed03);">
                        ...
                        <h5 class="fw-bold mb-0" style="color: #003566;">Photo Gallery</h5>
                    </div>
                </a>
            </div>
            <div class="col-12 col-md-4">
                <a href="<?php echo url('/certificates'); ?>" class="text-decoration-none">
                    <div class="card border-0 shadow-sm hover-lift rounded-4 overflow-hidden text-center p-4 h-100" style="background: linear-gradient(135deg, #FFBF0008, #FFBF0003);">
                        <div class="icon-circle mx-auto mb-3" style="width: 64px; height: 64px; background: rgba(255,191,0,0.15);">
                            <i class="fas fa-certificate fa-2x" style="color: #FFBF00;"></i>
                        </div>
                        <h5 class="fw-bold mb-0" style="color: #003566;">Certifications</h5>
                    </div>
                </a>
            </div>
            <div class="col-12 col-md-4">
                <a href="<?php echo url('/achievements'); ?>" class="text-decoration-none">
                    <div class="card border-0 shadow-sm hover-lift rounded-4 overflow-hidden text-center p-4 h-100" style="background: linear-gradient(135deg, #0d948808, #0d948803);">
                        <div class="icon-circle mx-auto mb-3" style="width: 64px; height: 64px; background: rgba(13,148,136,0.12);">
                            <i class="fas fa-trophy fa-2x" style="color: #0d9488;"></i>
                        </div>
                        <h5 class="fw-bold mb-0" style="color: #003566;">Achievements</h5>
                    </div>
                </a>
            </div>
        </div>
...
<section class="py-5" style="background: #fffff0;">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold display-6" style="color: #003566;">Latest News</h2>
                ...
                <a href="<?php echo url('news/' . $news->slug); ?>" class="text-decoration-none">
                    <div class="card border-0 shadow-sm hover-lift rounded-4 overflow-hidden h-100">
                        <div style="height: 180px; overflow: hidden; position: relative;">
                            ...
                            <?php else: ?>
                                <div class="w-100 h-100 d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #FFBF0010, #00356605);">
                                    <i class="fas fa-newspaper fa-3x" style="color: #FFBF00; opacity: 0.2;"></i>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="card-body p-3">
                            <div class="text-muted mb-1" style="font-size: 0.7rem;">
                                <i class="far fa-calendar-alt me-1" style="color: #0d9488;"></i> <?php echo date('d M Y', strtotime($news->created_at)); ?>
                            </div>
...
<section class="py-4" style="background: #fffff0; border-top: 1px solid #e5e7eb;">
    <div class="container-fluid px-0">
        <div class="text-center mb-3">
            <span class="badge px-4 py-2 rounded-pill mb-2 fw-bold" style="background: rgba(0,53,102,0.1); color: #003566; font-size: 0.9rem; letter-spacing: 1px;">Our Partners</span>
        </div>
            ...
            <div class="d-flex align-items-center" id="partnersMarquee" style="animation: scrollPartners 20s linear infinite; width: fit-content;">
                ...
                <?php foreach ($partnerData as $partner): ?>
                    <div class="text-center flex-shrink-0 px-3" style="min-width: 140px; max-width: 200px;">
                        ...
                        <?php else: ?>
                            <span class="fw-bold d-block" style="color: #003566; font-size: 1rem; line-height: 90px;"><?php echo htmlspecialchars($partner->name); ?></span>
                        <?php endif; ?>
                        <?php if (!empty($partner->website)): ?>
                            </a>
                        <?php endif; ?>
