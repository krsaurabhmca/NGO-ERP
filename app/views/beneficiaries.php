                        ...
                        <div class="card text-center p-4 h-100">
                            <div class="mb-3 mx-auto">
                                <?php if (!empty($b->photo)): ?>
                                    <img src="<?php echo file_url($b->photo); ?>" class="rounded-circle" alt="<?php echo htmlspecialchars($b->name); ?>" style="width: 90px; height: 90px; object-fit: cover; border: 3px solid var(--primary)15;">
                                <?php else: ?>
