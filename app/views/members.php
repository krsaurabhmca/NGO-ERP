                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card text-center p-4 h-100">
                            <div class="mb-3 mx-auto">
                                <?php if ($member->image): ?>
                                    <img src="<?php echo file_url($member->image); ?>" class="rounded-circle" alt="<?php echo htmlspecialchars($member->name); ?>" style="width: 90px; height: 90px; object-fit: cover; border: 3px solid #00356615;">
                                <?php else: ?>
