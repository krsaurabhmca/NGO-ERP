    ...
    <div class="container-fluid px-lg-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-7">
                ...
                <h2 class="fw-bold display-6 mb-3" style="color: #003566;">Our Story</h2>
                ...
                <div class="d-flex align-items-center gap-4 flex-wrap">
                    ...
                    <a href="<?php echo url('/projects'); ?>" class="btn rounded-pill px-4 py-2" style="border: 2px solid #0d9488; color: #0d9488; font-weight: 600;">
        ...
        <div class="row g-4 mt-5">
            <div class="col-6 col-md-3">
                <div class="stat-box h-100 text-center rounded-4 p-4" style="background: #fffff0; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
                    <div class="fw-bold fs-3 mb-1" style="color: #003566;">10+</div>
                    <div class="small fw-semibold" style="color: #64748b;">Years of Service</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="stat-box h-100 text-center rounded-4 p-4" style="background: #fffff0; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
                    <div class="fw-bold fs-3 mb-1" style="color: #FFBF00;">50+</div>
                    <div class="small fw-semibold" style="color: #64748b;">Projects Completed</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="stat-box h-100 text-center rounded-4 p-4" style="background: #fffff0; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
                    <div class="fw-bold fs-3 mb-1" style="color: #0d9488;">5K+</div>
...
<section class="py-5" style="background: #FFFFDE;">
    <div class="container-fluid px-lg-5">
        <div class="text-center mb-5">
            <span class="badge px-3 py-2 rounded-pill mb-3 fw-semibold" style="background: rgba(0,53,102,0.1); color: #003566;">Our Purpose</span>
            <h2 class="fw-bold display-6 mb-2" style="color: #003566;">Mission & Vision</h2>
                ...
                <div class="card h-100 border-0 shadow-sm p-4 rounded-4 hover-lift position-relative overflow-hidden">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3 d-flex align-items-center justify-content-center rounded-3" style="width: 56px; height: 56px; background: rgba(0,53,102,0.1);">
                            <i class="fas fa-bullseye fs-4" style="color: #003566;"></i>
                        </div>
                        <div>
                            <h3 class="fw-bold mb-0 h4" style="color: #003566;">Our Mission</h3>
                ...
                <div class="card h-100 border-0 shadow-sm p-4 rounded-4 hover-lift position-relative overflow-hidden">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3 d-flex align-items-center justify-content-center rounded-3" style="width: 56px; height: 56px; background: rgba(255,191,0,0.15);">
                            <i class="fas fa-eye fs-4" style="color: #FFBF00;"></i>
                        </div>
                        <div>
                            <h3 class="fw-bold mb-0 h4" style="color: #003566;">Our Vision</h3>
...
<section class="py-5" style="background: #fffff0;">
    <div class="container-fluid px-lg-5">
        <div class="text-center mb-5">
            <span class="badge px-3 py-2 rounded-pill mb-3 fw-semibold" style="background: rgba(13,148,136,0.12); color: #0d9488;">Our Values</span>
            <h2 class="fw-bold display-6 mb-2" style="color: #003566;">Core Values</h2>
            <p class="text-secondary fs-5">The principles that guide our work and shape our impact.</p>
        </div>
        <div class="row g-4">
            <div class="col-12 col-md-3">
                <div class="card shadow-sm text-center h-100 rounded-4 hover-lift p-4" style="border: 2px solid #003566 !important;">
                    <div class="mx-auto mb-3 d-flex align-items-center justify-content-center rounded-circle" style="width: 72px; height: 72px; background: #fffff0;">
                        ...
                        <?php else: ?>
                            <i class="<?php echo htmlspecialchars($cms->value_integrity_icon ?? 'fas fa-shield-alt'); ?> fs-1" style="color: #003566;"></i>
                        <?php endif; ?>
                    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="card shadow-sm text-center h-100 rounded-4 hover-lift p-4" style="border: 2px solid #FFBF00 !important;">
                    <div class="mx-auto mb-3 d-flex align-items-center justify-content-center rounded-circle" style="width: 72px; height: 72px; background: #fffff0;">
                        ...
                        <?php else: ?>
                            <i class="<?php echo htmlspecialchars($cms->value_compassion_icon ?? 'fas fa-heart'); ?> fs-1" style="color: #FFBF00;"></i>
                        <?php endif; ?>
                    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="card shadow-sm text-center h-100 rounded-4 hover-lift p-4" style="border: 2px solid #0d9488 !important;">
                    <div class="mx-auto mb-3 d-flex align-items-center justify-content-center rounded-circle" style="width: 72px; height: 72px; background: #fffff0;">
                        ...
                        <?php else: ?>
                            <i class="<?php echo htmlspecialchars($cms->value_innovation_icon ?? 'fas fa-lightbulb'); ?> fs-1" style="color: #0d9488;"></i>
                        <?php endif; ?>
                    </div>
...
<section class="py-5 position-relative overflow-hidden text-center" style="background: #003566;">
    <div class="container-fluid px-lg-5">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="<?php echo url('/contact'); ?>" class="btn btn-light rounded-pill px-5 py-2 d-inline-flex align-items-center justify-content-center fw-bold" style="color: #003566;">
                <i class="fas fa-handshake me-2"></i>Partner With Us
            </a>
            <a href="<?php echo url('/donate'); ?>" class="btn rounded-pill px-5 py-2 d-inline-flex align-items-center justify-content-center fw-bold" style="background: #FFBF00; color: #003566; border: none;">
