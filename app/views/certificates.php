...
<section class="position-relative overflow-hidden" style="background-color: var(--primary); background-image: radial-gradient(circle at 10% 20%, var(--accent) 0%, transparent 50%), radial-gradient(circle at 90% 80%, var(--accent) 0%, transparent 50%), radial-gradient(circle at 50% 50%, var(--primary-dark) 0%, transparent 70%);">
    <div class="container-fluid px-lg-5 py-5 text-center position-relative" style="z-index: 1;">
        ...
        <p class="text-white-50 mb-0">Official certifications and recognitions earned by our organization.</p>
    </div>
    ...
    <div class="container">
            ...
            <div class="row g-4">
                <?php foreach ($media as $item): ?>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card border-0 shadow-sm h-100 overflow-hidden hover-lift rounded-4" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#certModal" data-src="<?php echo file_url($item->file_path); ?>" data-title="<?php echo htmlspecialchars($item->title); ?>">
                            ...
                            <div class="card-body p-3 text-center border-top" style="background-color: var(--slate-100); border-left: 4px solid var(--primary);">
                                <p class="card-text fw-bold mb-0" style="font-size: 0.82rem; color: var(--primary);">
                                    <i class="fas fa-certificate me-1" style="color: var(--accent);"></i>
                ...
                <div class="modal-dialog modal-fullscreen-md-down modal-lg modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg" style="background: #0f172a;">
                        <div class="modal-header border-0 pb-0">
                            <h5 class="modal-title text-white fw-bold" id="certModalTitle"></h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body d-flex align-items-center justify-content-center p-4" style="min-height: 50vh;">
                            <img id="certModalImg" src="" class="img-fluid rounded-3" alt="" style="max-height: 75vh; object-fit: contain;">
                        </div>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                <i class="fas fa-certificate fa-3x text-muted mb-3 opacity-25"></i>
                <p class="text-muted fs-5">No certificates available yet.</p>
            </div>
        <?php endif; ?>
    </div>
</section>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (modal) {
        modal.addEventListener('show.bs.modal', function(e) {
            ...
            document.getElementById('certModalImg').src = btn.getAttribute('data-src');
            document.getElementById('certModalTitle').textContent = btn.getAttribute('data-title') || 'Certificate';
        });
